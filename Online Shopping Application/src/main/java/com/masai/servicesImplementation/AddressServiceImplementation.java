...
public class AddressServiceImplementation implements AddressService {
	...
	@Override
	public String removeAddress(String key, Integer addressId) throws CustomerException, LoginException, AddressException {

		Customer customer = loginLogoutCustomerServiceImplementation.validateCustomer(key);

		if (customer != null) {

			Optional<Address> optional_address = addressRepo.findById(addressId);  //(customer.getAddress().getAddressId());
			...
			if (optional_address.isPresent()) {
				...
				throw new AddressException(
						"No Address Found With The Address ID : " +  addressId); //customer.getAddress().getAddressId());
			}
