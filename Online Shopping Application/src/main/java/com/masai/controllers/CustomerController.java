...
public class CustomerController {
	...
	public ResponseEntity<String> removeCustomerHandler(@RequestParam String key, @Valid @RequestBody User user, @RequestParam Integer customer_Id)
			throws CustomerException, LoginException, UserException {

		String result = customerService.removeCustomer(key, user,  customer_Id);
